...
**중요: 위 질문에 대한 명확하고 직접적인 답변을 반드시 Markdown 형식으로 제공하세요.**
...
2. 그 다음 빈 줄로 구분 후 상세 설명을 Markdown 형식으로 작성

**중요: 섹션명 출력 금지**
- "상세 설명", "핵심 답변", "본문" 같은 섹션명을 절대 출력하지 마세요.
- 바로 내용만 Markdown 형식으로 작성하세요."""
