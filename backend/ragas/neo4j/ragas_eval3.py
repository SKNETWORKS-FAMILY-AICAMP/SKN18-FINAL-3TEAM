...
from backend.ragas.neo4j.chat_3hop import get_driver, answer_question_structured
...
RAW_PATH = RUN_DIR / "graphdb_eval3.raw.json"
SAMPLES_PATH = RUN_DIR / "graphdb_eval3.samples.pkl"
SCORES_PATH = RUN_DIR / "graphdb_eval3.scores.csv"
