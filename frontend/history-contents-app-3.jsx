...
// ========== 확장형 검색 컴포넌트 (Osklen 스타일) ==========
const ExpandableSearch = ({ isOpen, onClose, searchBarRef }) => {
              ...
              <div style={{ marginBottom: '28px' }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column' }}>
                  {searchHistory.map((item, idx) => (
                    ...
                    >
                      <span style={{ fontSize: '13px', color: COLORS.gray }}>{item}</span>
                      <button style={{
                        background: 'none',
                        border: 'none',
                        cursor: 'pointer',
                ...
                {suggestedVideos.map((video, idx) => (
                  ...
                  >
                    <div style={{
                      ...
                      alignItems: 'center',
                      justifyContent: 'center',
                      background: `linear-gradient(135deg, hsl(${idx * 25 + 200}, 15%, 92%) 0%, hsl(${idx * 25 + 220}, 20%, 88%) 100%)`,
                    }}
                    onMouseEnter={(e) => {
